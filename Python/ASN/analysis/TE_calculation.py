...
if __name__ == '__main__': 
    sim1 = defaultSimulation(connectivity__(filename = '100nw_261junctions'), 
                            lite_mode = True,
                            T = 210, dt = 1e-3, offTime = 10000000, 
    ...
    for i, this_dt in enumerate(dt_sample1):
        TE20000.append(calc_network(sim1, this_dt, N = 200, t_start = 10, calculator = 'kraskov'))
        TE40000.append(calc_network(sim2, this_dt, N = 400, t_start = 10, calculator = 'kraskov'))
